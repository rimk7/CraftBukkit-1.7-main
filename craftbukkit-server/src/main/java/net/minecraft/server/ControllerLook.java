...
public class ControllerLook {
    ...
    public void a() {
        ...
        if (this.d) {
            ...
            // CraftBukkit start - TrigMath -> FastMath
            float f = (float) (FastMath.atan2(d2, d0) * 180.0D / 3.1415927410125732D) - 90.0F;
            float f1 = (float) (-(FastMath.atan2(d1, d3) * 180.0D / 3.1415927410125732D));
            // CraftBukkit end
