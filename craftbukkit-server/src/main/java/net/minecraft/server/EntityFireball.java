    ...
    public void h() {
        if (!this.world.isStatic && (this.shooter != null && this.shooter.dead || !this.world.isLoaded((int) this.locX, (int) this.locY, (int) this.locZ))) {
            ...
            if (movingobjectposition != null) {
                ...
                if (this.dead) {
                    CraftEventFactory.callProjectileHitEvent(this, movingobjectposition.entity);
                }
                // CraftBukkit end
            }
            ...
            this.yaw = (float) (FastMath.atan2(this.motZ, this.motX) * 180.0D / 3.1415927410125732D) + 90.0F;

            for (this.pitch = (float) (FastMath.atan2((double) f1, this.motY) * 180.0D / 3.1415927410125732D) - 90.0F; this.pitch - this.lastPitch < -180.0F; this.lastPitch -= 360.0F) {
                ;
            }
