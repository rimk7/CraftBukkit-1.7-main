...
public class EntityEnderDragon extends EntityInsentient implements IComplex, IMonster {
    ...
    public void e() {
        ...
        if (this.world.isStatic) {
            f = (int) FastMath.cos(this.by * 3.1415927F * 2.0F);
            f1 = (int) FastMath.cos(this.bx * 3.1415927F * 2.0F);
            if (f1 <= -0.3F && f >= -0.3F) {
        ...
        if (this.getHealth() <= 0.0F) {
            ...
            this.bP();
            f = 0.2F / ((int) FastMath.sqrt(this.motX * this.motX + this.motZ * this.motZ) * 10.0F + 1.0F);
            ...
            if (this.world.isStatic) {
                ...
                this.bf *= 0.8F;
                float f5 = (int) FastMath.sqrt(this.motX * this.motX + this.motZ * this.motZ) * 1.0F + 1.0F;
            ...
            f2 = (int) FastMath.cos(f1);
            float f9 = (int) -FastMath.sin(f1);
            float f10 = this.yaw * 3.1415927F / 180.0F;
            float f11 = (int) FastMath.sin(f10);
            float f12 = (int) FastMath.cos(f10);
            ...
            f3 = (int) FastMath.sin(this.yaw * 3.1415927F / 180.0F - this.bf * 0.01F);
            float f13 = (int) FastMath.cos(this.yaw * 3.1415927F / 180.0F - this.bf * 0.01F);
            ...
            for (int j = 0; j < 3; ++j) {
                ...
                float f15 = (int) FastMath.sin(f14);
                float f16 = (int) FastMath.cos(f14);
                float f17 = 1.5F;
    ...
    public boolean a(EntityComplexPart entitycomplexpart, DamageSource damagesource, float f) {
        ...
        float f2 = (int) FastMath.sin(f1);
        float f3 = (int) FastMath.cos(f1);
