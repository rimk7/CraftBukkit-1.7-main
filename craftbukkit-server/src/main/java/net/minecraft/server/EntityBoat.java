    ...
    public void h() {
        ...
        if (this.world.isStatic && this.a) {
            ...
            if (this.passenger != null && this.passenger instanceof EntityLiving) {
                ...
                this.motX += -FastMath.sin((double) (f * 3.1415927F / 180.0F)) * this.b * (double) entityliving.be * 0.05000000074505806D;
                this.motZ += FastMath.cos((double) (f * 3.1415927F / 180.0F)) * this.b * (double) entityliving.be * 0.05000000074505806D;
            }
            ...
            for (k = 0; k < 4; ++k) {
                int l = (int) FastMath.floor(this.locX + ((double) (k % 2) - 0.5D) * 0.8D);

                j = (int) FastMath.floor(this.locZ + ((double) (k / 2) - 0.5D) * 0.8D);

                for (int i1 = 0; i1 < 2; ++i1) {
                    int j1 = (int) FastMath.floor(this.locY) + i1;
            ...
            if (d10 * d10 + d11 * d11 > 0.001D) {
                d5 = (double) ((float) (FastMath.atan2(d11, d10) * 180.0D / 3.141592653589793D));
            }
