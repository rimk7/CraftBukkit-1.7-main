...
public class BlockHopper extends BlockContainer {
    ...
    public static int b(int i) {
        return FastMath.min(i & 7, 5); // CraftBukkit - Fix AIOOBE in callers
    }
            ...
            for (int i1 = 0; i1 < tileentityhopper.getSize(); ++i1) {
                ...
                if (itemstack != null) {
                    ...
                    while (itemstack.count > 0) {
                        ...
                        itemstack.count -= j1;
                        EntityItem entityitem = new EntityItem(world, (float) i + f, (float) j + f1, (float) k + f2, new ItemStack(itemstack.getItem(), j1, itemstack.getData()));
