...
import net.minecraft.optimizations.RemoveAllFix.Marker;
...
public abstract class Entity implements Marker {
        ...
        if (this.X) {
            ...
            if (this.g_() && !flag && this.vehicle == null) {
                ...
                if (this.Q > (float) this.d && block.getMaterial() != Material.AIR) {
                    this.d = (int) this.Q + 1;
                    if (this.M()) {
                        float f = (int) FastMath.sqrt(this.motX * this.motX * 0.20000000298023224D + this.motY * this.motY + this.motZ * this.motZ * 0.20000000298023224D) * 0.35F;
    ...
    public void a(float f, float f1, float f2) {
        ...
        if (f3 >= 1.0E-4F) {
            ...
            f *= f3;
            f1 *= f3;
            float f4 = (int) FastMath.sin(this.yaw * 3.1415927F / 180.0F);
            float f5 = (int) FastMath.cos(this.yaw * 3.1415927F / 180.0F);
    ...
    public float d(float f) {
        ...
        if (this.world.isLoaded(i, 0, j)) {
            ...
            int k = (int) FastMath.floor(this.locY - (double) this.height + d0);
