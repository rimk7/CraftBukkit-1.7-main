...
public class TileEntityChest extends TileEntity implements IInventory {
    ...
    public void h() {
        ...
        if (!this.world.isStatic && this.o != 0 && (this.ticks + this.x + this.y + this.z) % 10 == 0) { // PaperSpigot Reduced 200 -> 10 interval due to reduced tick rate from Improved Tick Handling
            this.o = 0;
            f = 5.0F;
            List list = this.world.a(EntityHuman.class, AxisAlignedBB.a((float) this.x - f, (float) this.y - f, (float) this.z - f, (float) (this.x + 1) + f, (float) (this.y + 1) + f, (float) (this.z + 1) + f));
    ...
    public void startOpen() {
        ...
        int oldPower = FastMath.max(0, FastMath.min(15, this.o)); // CraftBukkit - Get power before new viewer is added
        ...
        if (this.q() == Blocks.TRAPPED_CHEST) {
            int newPower = FastMath.max(0, FastMath.min(15, this.o));
