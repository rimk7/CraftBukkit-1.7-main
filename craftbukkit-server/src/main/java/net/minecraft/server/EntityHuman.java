...
public abstract class EntityHuman extends EntityLiving implements ICommandListener {
    ...
    public boolean isAnimating() {
        return this.by() && this.f.getItem().d(this.f) == EnumAnimation.NONE;
    }
    ...
    public void e() {
        ...
        float f = (int) FastMath.sqrt(this.motX * this.motX + this.motZ * this.motZ);
    ...
    public EntityItem a(ItemStack itemstack, boolean flag, boolean flag1) {
        if (itemstack == null) {
            ...
            if (flag) {
                ...
                entityitem.motX = (double) (-FastMath.sin(f2) * f1);
                entityitem.motZ = (double) (FastMath.cos(f2) * f1);
                entityitem.motY = 0.20000000298023224D;
            } else {
                f = 0.3F;
                entityitem.motX = (double) (-FastMath.sin(this.yaw / 180.0F * 3.1415927F) * FastMath.cos(this.pitch / 180.0F * 3.1415927F) * f);
                entityitem.motZ = (double) (FastMath.cos(this.yaw / 180.0F * 3.1415927F) * FastMath.cos(this.pitch / 180.0F * 3.1415927F) * f);
                ...
                if (true) {
                    ...
                    if (flag2) {
                        if (i > 0) {
                            ...
                            entity.g(
                                    (double) (-FastMath.sin(this.yaw * 3.1415927F / 180.0F) * (float) i * SpigotConfig.knockbackExtraHorizontal),
                                    SpigotConfig.knockbackExtraVertical,
                                    (double) (FastMath.cos(this.yaw * 3.1415927F / 180.0F) * (float) i * SpigotConfig.knockbackExtraHorizontal));
                            // Kohi end
                            this.motX *= 0.6D;
                            this.motZ *= 0.6D;
