...
public abstract class EntityLiving extends Entity {
    ...
    protected void bj() {
        ...
        if (this.isSprinting()) {
            ...
            this.motZ += (double) (FastMath.cos(f) * 0.2F);
        }
    ...
    public void e(float f, float f1) {
        ...
        float f6 = (int) FastMath.sqrt(d0 * d0 + d1 * d1) * 4.0F;
    ...
    public Vec3D j(float f) {
        ...
        if (f == 1.0F) {
            f1 = (int) FastMath.cos(-this.yaw * 0.017453292F - 3.1415927F);
            f2 = (int) FastMath.sin(-this.yaw * 0.017453292F - 3.1415927F);
            f3 = (int) -FastMath.cos(-this.pitch * 0.017453292F);
            f4 = (int) FastMath.sin(-this.pitch * 0.017453292F);
            ...
            f3 = (int) FastMath.cos(-f2 * 0.017453292F - 3.1415927F);
            f4 = (int) FastMath.sin(-f2 * 0.017453292F - 3.1415927F);
            float f5 = (int) -FastMath.cos(-f1 * 0.017453292F);
            float f6 = (int) FastMath.sin(-f1 * 0.017453292F);
