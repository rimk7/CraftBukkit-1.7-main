...
public class EntityWither extends EntityMonster implements IRangedEntity {
    ...
    public void e() {
        ...
        if (this.motX * this.motX + this.motZ * this.motZ > 0.05000000074505806D) {
            this.yaw = (float) FastMath.atan2(this.motZ, this.motX) * 57.295776F - 90.0F;
        }
        ...
        for (i = 0; i < 2; ++i) {
            ...
            if (entity1 != null) {
                ...
                float f = (float) (FastMath.atan2(d6, d4) * 180.0D / 3.1415927410125732D) - 90.0F;
                float f1 = (float) (-(FastMath.atan2(d5, d7) * 180.0D / 3.1415927410125732D));
        ...
        if (this.ca() > 0) {
            ...
            if (this.bv > 0) {
                ...
                if (this.bv == 0 && this.world.getGameRules().getBoolean("mobGriefing")) {
                    ...
                    j = (int) FastMath.floor(this.locX);
