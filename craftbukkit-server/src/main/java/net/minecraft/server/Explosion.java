...
public class Explosion {
    ...
    public void a() {
                ...
                for (k = 0; k < this.i; ++k) {
                    if (i == 0 || i == this.i - 1 || j == 0 || j == this.i - 1 || k == 0 || k == this.i - 1) {
                        ...
                        for (float f2 = 0.3F; f1 > 0.0F; f1 -= f2 * 0.75F) {
                            int l = (int) FastMath.floor(d0);
                            int i1 = (int) FastMath.floor(d1);
                            int j1 = (int) FastMath.floor(d2);
        ...
        this.size *= 2.0F;
        i = (int) FastMath.floor(this.posX - (double) this.size - 1.0D);
        j = (int) FastMath.floor(this.posX + (double) this.size + 1.0D);
        k = (int) FastMath.floor(this.posY - (double) this.size - 1.0D);
        int k1 = (int) FastMath.floor(this.posY + (double) this.size + 1.0D);
        int l1 = (int) FastMath.floor(this.posZ - (double) this.size - 1.0D);
        int i2 = (int) FastMath.floor(this.posZ + (double) this.size + 1.0D);
        ...
        for (int j2 = 0; j2 < list.size(); ++j2) {
            ...
            if (d7 <= 1.0D) {
                ...
                double d8 = (double) FastMath.sqrt(d0 * d0 + d1 * d1 + d2 * d2);
