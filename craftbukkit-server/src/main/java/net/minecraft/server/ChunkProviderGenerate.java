...
public class ChunkProviderGenerate implements IChunkProvider {
    ...
    public Chunk getOrCreateChunk(int i, int j) {
        ...
        if (this.n.paperSpigotConfig.generateCaves && this.n.generatorConfig.cavesMultiplier > 0) {
            /*if (FastMath.abs(x) > 100 || FastMath.abs(z) > 100) {
                this.t.a(this, this.n, i, j, ablock);
            }*/
            this.t.a(this, this.n, i, j, ablock); // Stormworth
        }
    ...
    public void getChunkAt(IChunkProvider ichunkprovider, int i, int j) {
        ...
        if (biomebase != BiomeBase.DESERT && biomebase != BiomeBase.DESERT_HILLS && !flag && this.i.nextInt(5) == 0) { // Stormworth (before 4)
            k1 = k + this.i.nextInt(16) + 8;
            l1 = this.i.nextInt(256);
            i2 = l + this.i.nextInt(16) + 8;

            if(FastMath.abs(k1) > 100 && FastMath.abs(i2) > 100) {
        ...
        if (!flag && this.i.nextInt(8) == 0) {
            ...
            if (l1 < 63 || this.i.nextInt(10) == 0) {
                if(FastMath.abs(k1) > 25 && FastMath.abs(i2) > 25) {
