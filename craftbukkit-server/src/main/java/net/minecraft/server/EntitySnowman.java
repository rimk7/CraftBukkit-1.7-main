...
public class EntitySnowman extends EntityGolem implements IRangedEntity {
    ...
    public void e() {
        ...
        for (int l = 0; l < 4; ++l) {
            i = (int) FastMath.floor(this.locX + (double) ((float) (l % 2 * 2 - 1) * 0.25F));
            j = (int) FastMath.floor(this.locY);
            k = (int) FastMath.floor(this.locZ + (double) ((float) (l / 2 % 2 * 2 - 1) * 0.25F));
    ...
    public void a(EntityLiving entityliving, float f) {
        ...
        float f1 = (float) (FastMath.sqrt(d0 * d0 + d2 * d2) * 0.2F);
